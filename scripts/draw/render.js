...
drawKeystroke(e, isWord) {
  // Print the current x and y coordinates of the typewriter
  console.log('before x: ' +this.$typewriterX);
  console.log('before y: ' +this.$typewriterY);
  ...
  if (isWord) {
    ...
    // Print the updated x and y coordinates of the typewriter
    console.log('after x: ' +this.$typewriterX);
    console.log('after y: ' +this.$typewriterY);
    return;
  }
  ...
  if (e.key.length === 1) {
    ...
    if (prevCharX <= this.xnppos -14 && prevCharY === this.ynppos) {
      return;
    } else if (!(prevCharX <= this.xnppos && prevCharY > this.ynppos) && prevCharX < this.xnppos && prevCharY > this.ynppos) {
...
scroll(y) {
  // Translate the canvas content based on the scroll position
